...
<head>
  ...
  <title>KTH-3 | Project Edit</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="../projects/update" method="post" enctype="multipart/form-data">
        <input type="hidden" name="pid" id="inputPid" class="form-control" value="${pDto.pid}">
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea id="inputDescription" name="project-description" class="form-control" rows="4">
                  ${pDto.projectDescription}</textarea>
              </div>
              <div class="form-group">
                ...
                <select id="inputStatus" class="form-control custom-select" name="status">
                  ...
                  <c:choose>
                    ...
                    <c:when test="${pDto.status == 'Canceled'}">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <div class="custom-file">
                    <input type="file" name="project-image" id="exampleInputFile" class="custom-form-control" onchange="changeLabel(this)">
                    <label class="custom-file-label" for="exampleInputFile">${empty pDto.projectImage ? 'Choose file' : pDto.projectImage}</label>
                  </div>
                </div>
              </div>
            </div>
