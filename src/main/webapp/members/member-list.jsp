...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="./index3.jsp" class="brand-link">
      ...
      <span class="brand-text font-weight-light">KTH</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../tables/member-list.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Simple Tables</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../examples/login-v2.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Login v2</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../examples/register-v2.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Register v2</p>
                    </a>
                  </li>
...
<%--                      out.print("<tr>");--%>
<%--                      out.print("<td>" + m.getFullName() + "</td>");--%>
<%--                      out.print("<td><span class =\"tag tag-success\">" + m.getEmail() + "</span></td>");--%>
<%--                      out.print("<td>" + m.getPw() +"</td>");--%>
<%--                      out.print("</tr>");--%>
